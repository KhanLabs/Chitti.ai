...
}else if (userInput.toLowerCase().includes("mpsc") || userInput.toLowerCase().includes("")) {
...
}else if (userInput.toLowerCase().includes("upsc") || userInput.toLowerCase().includes("")) {
...
}else if (userInput.toLowerCase().includes("bpsc") || userInput.toLowerCase().includes("")) {
